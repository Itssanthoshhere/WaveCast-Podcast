    ...
    <>
      ...
      <div className="dark-section">
        <div className="px-[8%] lg:px-[16%] py-30 pb-0 md:pb-10 relative">
          {/* Search Episodes */}
          <div className="hidden w-full bg-(--gray-color) px-5 py-3 rounded-full md:flex justify-between items-center gap-5 episode-search">
            <input
              type="text"
          ...
          <div className="flex justify-between items-center gap-5">
            ...
            <div className="relative hidden md:flex ">
              <select
                ...
                className="appearance-none bg-(--gray-color) text-(--primary) px-5 py-3 pr-12 rounded-full outline-none cursor-pointer font-medium hover:bg-(--gray-light) transition-all duration-300"
              >
          ...
          {EpisodesData.length > 10 && (
            <div className="flex justify-center mt-12">
              <button className="btn btn2" onClick={() => setShowAll(!showAll)}>
